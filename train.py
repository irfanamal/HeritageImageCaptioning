...
if __name__=='__main__':
    ...
    train_dataset = Dataset.HeritageDataset('dataset/data3/train_unpack.csv', 'dataset/data3/images', 'dataset/data3/bounding_box', vocab, transform, transform2, True)
    ...
    val_dataset = Dataset.HeritageDataset('dataset/data3/val_unpack.csv', 'dataset/data3/images', 'dataset/data3/bounding_box', vocab, transform, transform2, True)
...
#             h0 = h0.repeat_interleave(5, 0)
#             object_proposals = object_proposals.repeat_interleave(5, 0)
#             captions = torch.flatten(captions, 0, 1)
#             lengths = torch.flatten(lengths).unsqueeze(1)
...
#                 lengths = torch.flatten(lengths).unsqueeze(1)
        ...
        if val_loss < min_val_loss:
            ...
            torch.save(caption_generator.state_dict(), 'checkpoint/models2/data3/{}/caption_generator.pt'.format(experiment_num))
            torch.save(global_encoder.state_dict(), 'checkpoint/models2/data3/{}/global_encoder.pt'.format(experiment_num))
            torch.save(object_descriptor.state_dict(), 'checkpoint/models2/data3/{}/object_descriptor.pt'.format(experiment_num))

        with open('logs/models2/data3/{}/train_log.txt'.format(experiment_num), 'a+') as f:
    ...
    with open('logs/models2/data3/{}/hyperparams.txt'.format(experiment_num), 'a+') as f:
